...
-- CreateEnum
CREATE TYPE "DataSourceType" AS ENUM ('GOOGLE_ANALYTICS_4', 'GOOGLE_ADS', 'META_ADS', 'GOOGLE_SEARCH_CONSOLE', 'MANUAL_CSV');
...
CREATE TABLE "ReportDataSource" (
    ...
    CONSTRAINT "ReportDataSource_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "UsageRecord" (
    ...
    "pdfsExported" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX "Report_clientViewToken_key" ON "Report"("clientViewToken");

-- CreateIndex
CREATE UNIQUE INDEX "ReportDataSource_reportId_dataSourceId_key" ON "ReportDataSource"("reportId", "dataSourceId");
...
-- AddForeignKey
ALTER TABLE "DataSource" ADD CONSTRAINT "DataSource_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "Client"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ReportDataSource" ADD CONSTRAINT "ReportDataSource_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "Report"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReportDataSource" ADD CONSTRAINT "ReportDataSource_dataSourceId_fkey" FOREIGN KEY ("dataSourceId") REFERENCES "DataSource"("id") ON DELETE CASCADE ON UPDATE CASCADE;
